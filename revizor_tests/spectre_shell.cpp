...
int main(int argc, char* argv[])
{
  ...
  asm volatile(""
    ...
    ".l0:\n"
        // # rbx != 0
        // "MOV rax, qword ptr [r14 + rax]\n" //TODO BROKEN, segfaults on bad mem region!
    "JMP .l2\n"
    ".l1:\n"
        // # rbx == 0
  ...
  // INFO run on laptop; use gdb (SI, NI asm cmds)
  // alternatively, get gem5 tarmac dump

  // Violation either occured or didn't by this point, exit gracefully
  uint64_t output_value = *((uint64_t*)output);
  cout << "Finished running spectre code" << endl;
  cout << "Output of spectre code chunk: " << output_value << endl; // Give some output from spectre, even if garbage
